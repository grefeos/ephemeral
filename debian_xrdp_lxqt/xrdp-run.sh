...
while [ $# -ne 0 ]; do
    ...
    mkdir /home/$1/.config/lxqt
    chown $1:$1 /home/$1/.config/lxqt
    cat /etc/.globalkeyshortcuts.conf > /home/$1/.config/lxqt/globalkeyshortcuts.conf
    chown $1:$1 /home/$1/.config/lxqt/globalkeyshortcuts.conf
